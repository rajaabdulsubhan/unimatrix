                    ...
                    foreach ($userData as $val) {
                        ...
                        if ($val['txstatus'] == 2) {
                            ...
                            if ($val['txfromid'] == 0) {
                                ...
                                $bletmark = '<i class="fa fa-caret-down fa-fw ' . $statusclor . '"></i>';
                            } elseif ($val['txtoid'] == 0) {
                                $statusclor = ($val['txstatus'] == 1) ? 'text-success' : 'text-secondary';
                                $bletmark = '<i class="fa fa-caret-up fa-fw ' . $statusclor . '"></i>';
                            } else {
                        ...
                        $refuname = ($txrefid > 0) ? "<div>" . $LANG['g_reference'] . ' - <strong>' . getusernameid($txrefid, 'username') . "</strong></div>" : '';
                        ...
                        <tr>
                            ...
                            <td align="center" nowrap>
                                <a href="javascript:;"
                                   ...
                                   data-content="<h6><?php echo myvalidate($val['txtmstamp']); ?></h6><div>From: <?php echo myvalidate($payfrom); ?></div><div>To: <?php echo myvalidate($payto); ?></div><?php echo myvalidate($refuname); ?><div class='mt-2'><?php echo myvalidate($txmemostr); ?></div><div class='mt-2'><?php echo myvalidate($val['txadminfo']); ?></div>">
