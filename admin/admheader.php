...
$admusern = ($_SESSION['isunsubadm']) ? base64_decode($_SESSION['isunsubadm']) : $cfgrow['admin_user'];

if ($bpprow['maxwidth'] == 0 && $plantokenarr['isgenview'] == '1') {
    $menuactive['genealogylist'] = " style='display:none;'";
}

$updatebtnstr = (!defined('ISDEMOMODE') && $_SESSION['isunsubadm'] == '') ? '<a href="index.php?hal=updates" class="btn btn-success btn-lg btn-block btn-icon-split"><i class="fas fa-rocket"></i> ' . $LANG['a_updates'] . '</a>' : '';
