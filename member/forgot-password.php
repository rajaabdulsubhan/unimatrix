...
if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1') {
    ...
    if ($mbrid > 0) {
        ...
        $resent = delivermail('mbr_resetpass', $mbrid, $cntaddarr);

        $_SESSION['show_msg'] = ($resent) ? showalert('primary', 'Reset Request', 'A reset link has been sent to your email address. Please check it.') : showalert('warning', 'Email Disable', 'Email notification was disabled by the administrator!<br />Please make a password reset request manually.');
        ;
    } else {
