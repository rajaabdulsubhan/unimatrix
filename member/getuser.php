                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6 col-12">
                                ...
                                <h6 class="alert alert-light"><a href="index.php?hal=getuser&getId=<?php echo myvalidate($rowrefstr['mpid']); ?>" data-toggle="tooltip" title="<?php echo myvalidate($rowrefstr['firstname'] . ' ' . $rowrefstr['lastname']); ?>"><?php echo myvalidate($rowrefstr['username']); ?></a></h6>
                            </div>
                            <div class="form-group col-md-6 col-12">
                                <label>Sponsor</label>
                                <h6 class="alert alert-light"><a href="index.php?hal=getuser&getId=<?php echo myvalidate($rowsprstr['mpid']); ?>" data-toggle="tooltip" title="T<?php echo myvalidate($rowsprstr['firstname'] . ' ' . $rowsprstr['lastname']); ?>"><?php echo myvalidate($rowsprstr['username']); ?></a></h6>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6 col-12">
