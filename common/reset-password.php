    ...
    if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1') {
        ...
        if ($password != $passwordconfirm) {
            ...
            if ($sesRow['sesid'] > 0 && $dataarr[0] == 'resetpass') {
                ...
                $_SESSION['show_msg'] = showalert('success', 'Congratulation', 'New password have been applied. You can log in to your back office using your new password. Thank you!');
            } else {
